...
// Alat utama untuk Autentikasi dan Database
...
function HomeScreen({onLogout, userEmail}) { 
  ...
  useEffect(() => {
    //  Mengambil data dari Firestore (Persistence by Firebase Rules)
...
function App(): React.JSX.Element {
  ...
  // Handle user state changes (Persistence otomatis dari Firebase Auth)
  ...
  useEffect(() => {
    // Listener ini menangani persistence (user tidak perlu login ulang)
